...
export default function SettingsPage() {
  ...
  return (
    <div className="space-y-6 pb-8">
      <section className="overflow-hidden rounded-[2.25rem] border border-sky-100 bg-[radial-gradient(circle_at_top_left,rgba(14,165,233,0.16),transparent_34%),linear-gradient(135deg,#f8fffb_0%,#ffffff_100%)] p-6 shadow-[0_24px_60px_rgba(14,165,233,0.10)] animate-fade-in-down">
        <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl">
            <p className="text-xs font-semibold uppercase tracking-[0.28em] text-sky-700">Settings</p>
      ...
      <form onSubmit={handleSubmit} className="rounded-4xl border border-sky-100 bg-white p-8 shadow-[0_18px_45px_rgba(15,23,42,0.06)] animate-fade-in-up stagger-1">
        ...
        <fieldset disabled={loading || !canEdit || isSaving} className="mt-6 space-y-6">
          <div>
            <label className="block text-sm font-medium text-slate-700">Clinic Name</label>
              ...
              className="mt-2 w-full rounded-2xl border border-sky-100 px-3 py-3 outline-none transition focus:border-sky-400 focus:ring-4 focus:ring-sky-100"
            />
          </div>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            <div>
              ...
              <input
                ...
                className="mt-2 w-full rounded-lg border border-slate-200 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-sky-100 focus:border-sky-400"
              />
            </div>
            <div>
                ...
                {meetingLinkClass.state === "invalid" ? (
                  ...
                  {meetingLinkClass.state === "valid-known" ? (
                    <p className="inline-flex items-center gap-1.5 text-sky-700">
                      <FaCircleCheck className="h-3 w-3 text-sky-600" aria-hidden="true" />
          ...
          {canEdit ? (
            <button
              ...
              className="rounded-full bg-sky-600 px-6 py-3 font-semibold text-white shadow-[0_14px_28px_rgba(14,165,233,0.18)] transition hover:-translate-y-0.5 disabled:cursor-not-allowed disabled:bg-sky-300"
            >
